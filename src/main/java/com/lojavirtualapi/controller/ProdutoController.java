...
import com.lojavirtualapi.service.ProdutoService;
...
public class ProdutoController {
    ...
    @GetMapping
    public List<ProdutoResponseDTO> listar(@RequestParam(required = false) String nome, @RequestParam(required = false) Long categoriaId) {
